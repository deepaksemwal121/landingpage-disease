      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="flex flex-col items-center">
          <img
            ...
            className="rounded-full w-[300px] h-[300px] border-4 border-gray-200"
            alt=""
          />
          <p className="text-[24px] font-semibold">Advanced Care</p>
        </div>{" "}
        <div className="flex flex-col items-center">
          <img
            ...
            alt=""
          />
          <p className="text-[24px] font-semibold">Specialized Institution </p>
        </div>{" "}
        <div className="flex flex-col items-center">
          <img
            ...
            alt=""
          />
          <p className="text-[24px] font-semibold">Success Rate</p>
        </div>
      </div>
    </div>
  );
